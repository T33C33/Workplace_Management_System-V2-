...
class Seat(db.Model):
    ...
    position_x = db.Column(db.Integer, default=0)  # X coordinate for seat positioning
    position_y = db.Column(db.Integer, default=0)  # Y coordinate for seat positioning
